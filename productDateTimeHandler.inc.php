 ...
 **********************************************************************/
function datetime_handler_AQUARIUS_L3_SSS_SMI_7DAY(&$file_info) {
  bunzip_dataset($file_info['path'],$hdf5_filename);
 ...
 **********************************************************************/
 function datetime_handler_EUR_L2P_AVHRR_METOP_A(&$file_info) {
 ...
 **********************************************************************/
function datetime_handler_IFR_L4_SSTfnd_ODYSSEA_GLOB_010(&$file_info) {
  bunzip_dataset_partial($file_info['path'],$nc_filename,8192);
  ncdump_xml($nc_filename, $xml_filename);
 ...
 **********************************************************************/
function datetime_handler_IFR_L4_SSTfnd_ODYSSEA_MED_002(&$file_info) {
  return datetime_handler_IFR_L4_SSTfnd_ODYSSEA_GLOB_010($file_info);
}
 ...
 **********************************************************************/
function datetime_handler_JPL_OUROCEAN_L4UHfnd_GLOB_G1SST(&$file_info) {
  datetime_handler_JPL_L4UHfnd_GLOB_MUR($file_info);
}

/***********************************************************************
 * MERCI_MER_RR_1P => MERCI_MER_RR_1P
 **********************************************************************/
function datetime_handler_MERCI_MER_RR_1P(&$file_info) {
  gunzip_dataset_partial($file_info['path'],$n1_filename, 480);
 ...
 **********************************************************************/
function datetime_handler_NCDC_SEAWINDS_OW_6hr(&$file_info) {
  ncdump_xml($file_info['path'], $xml_filename);
  //debug("[DEBUG] xml_filename = $xml_filename\n");
 ...
 **********************************************************************/
function datetime_handler_NCEP_CFSR1HR(&$file_info) {
  $dt = extract_datetime_array_from_filepath($file_info['path'],
    $file_info['product_id_regex_matching']);
 ...
 * NCEP_GFS => NCEP_GFS
 **********************************************************************/
function datetime_handler_NCEP_GFS(&$file_info) {
  $dt = extract_datetime_array_from_filepath($file_info['path'],
    $file_info['product_id_regex_matching']);
 ...
 **********************************************************************/
function datetime_handler_OISST_AVHRR_AMSR_V2(&$file_info) {
  $dt = extract_datetime_array_from_filepath($file_info['path'],
    $file_info['product_id_regex_matching']);
 ...
 **********************************************************************/
function datetime_handler_OISST_AVHRR_V2(&$file_info) {
  return datetime_handler_OISST_AVHRR_AMSR_V2($file_info);
}

/***********************************************************************
 * OSTIA => OSTIA
 **********************************************************************/
function datetime_handler_OSTIA(&$file_info) {
  bunzip_dataset_partial($file_info['path'],$nc_filename,8192);
  ncdump_xml($nc_filename, $xml_filename);
  //debug("[DEBUG] nc_filename = $nc_filename\n");
  //debug("[DEBUG] xml_filename = $xml_filename\n");
 ...
 **********************************************************************/
function datetime_handler_QSCAT_L2B12(&$file_info) {
  gunzip_dataset($file_info['path'],$hdf_filename);
  ...
  if (preg_match("/RangeBeginningDate\s+.*\s+.*\s.*(\d{4})-(\d{3})/",$content, $dt1) &&
    ...
    trigger_error("Unable to read start and stop datetime in ".$file_info['path'], E_USER_ERROR);
  }
}
 ...
 * SSMI => SSMI
 **********************************************************************/
function datetime_handler_SSMI(&$file_info) {
  $dt = extract_datetime_array_from_filepath($file_info['path'],
    $file_info['product_id_regex_matching']);
